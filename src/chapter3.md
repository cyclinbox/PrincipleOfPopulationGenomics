...
图3.4所示的等位基因频率变化模式与理想人群的理论预期非常接近，如图3.5所示。该分布是通过矩阵的连续乘法获得的，矩阵的元素由方程3.2中的转移概率给出。尽管全面的随机遗传漂变理论需要超出本书范围的数学（参见木村195519641976；赖特1969；克劳和木村1970；木村和奥塔1971；尤恩斯2004），但在下一节中，我们提供了一个介绍性的花絮来传授这一味道。如果你是一个没有微积分背景的学生，但请不要气馁，因为详细的理解对于理解本章的其余部分或本书后面的任何内容都是不必要的。
